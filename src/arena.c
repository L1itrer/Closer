...
void sys_info_get(SysInfo* info)
{
#error sys_info_get not implemented
}


static void* sys_reserve_memory(uint64_t size)
{
#error sys_reserve_memory not implemented
}
static void sys_commit_memory(void *ptr, uint64_t size)
{
#error sys_commit_memory not implemented
}


static void sys_release_memory(void *ptr, uint64_t size)
{
#error sys_release_memory not yet implemented
}
#else
#include <unistd.h>
#include <fcntl.h>
